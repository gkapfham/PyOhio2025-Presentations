...
## Features
(questions: these features are listed on the Chasten repo - I just listed some notable features here )
...
- 📚 **Integrates into grading pipelines**  
  ...
  ## Current limitations
  - Chasten is best used alongside other linters - it doesn't cover style, formatting, or pre-defined PEP8 rules
  - Not optimized for speed or massive-scale projects 
  - Doesn't enforce fixed rule sets - it won't tell you what's "correct", depends on your familiarity with ASTs and XPath

  ## Future limitation 
  - Have hints/ automatic fixing of the code 
  - LSP integration or IDE integration
  - Should be a default set of rules that let examiners pick and choose to run the projects on 
